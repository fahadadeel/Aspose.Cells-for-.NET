...
## Overview
This workflow automatically generates documentation for Aspose.Cells .NET examples by creating GitHub Gists and embedding them in Hugo documentation format.
