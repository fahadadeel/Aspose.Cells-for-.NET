...
/**
 * Detects new or modified examples in the Examples/CSharp directory
...
/**
 * Check if a file is an example file in Examples/CSharp
 */
function isExampleFile(filePath) {
  ...
  // Must be in Examples/CSharp directory
  if (!pathParts.includes("Examples") || !pathParts.includes("CSharp")) {
    return false;
  }
  ...
  // Skip test files and certain system files
  const fileName = path.basename(normalizedPath);
  if (fileName.includes("Test") || fileName === "RunExamples.cs") {
    return false;
  }
