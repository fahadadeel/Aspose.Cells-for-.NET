...
/**
 * Generates documentation for Aspose.Cells examples using LiteLLM API.
...
class DocumentationGenerator {
    ...
    async analyzeExampleCode(codeContent, filePath) {
        const prompt = `
Analyze this Aspose.Cells for .NET example code and provide structured information:
...
3. Category: The main category (Data, Worksheets, Formatting, Charts, Formulas, etc.)
4. Excel Features: List of Excel features used (e.g., Workbook, Worksheet, Cells, Range, Chart)
5. Key Features: List of key Aspose.Cells features demonstrated (MUST be an array of simple strings)
...
IMPORTANT: 
- title MUST be 4 words or less (e.g., "Basic Workbook Creation", "Cell Formatting Example", "Chart Creation Demo")
...
Example format:
{
  "title": "Workbook Creation Example",
  "description": "Shows how to create Excel workbooks",
  "category": "Data",
  "barcode_types": ["Workbook", "Worksheet"],
  "key_features": ["License initialization", "Workbook creation", "File saving"],
  "keywords": ["excel", "workbook", "creation", "Aspose.Cells"],
  "technical_summary": "...",
  "code_explanation": "..."
}
`;
        ...
        const payload = {
            ...
            messages: [
                {
                    role: 'system',
                    content: 'You are an expert technical writer specializing in Aspose.Cells for .NET documentation. Analyze code examples and provide comprehensive, accurate technical documentation.'
                },
                {
                    role: 'user',
                    content: prompt
    ...
    fallbackAnalysis(codeContent, filePath) {
        ...
        return {
            ...
            key_features: ['Excel Operations', 'File Output', 'Custom Parameters'],
            keywords: ['Aspose.Cells', '.NET', category, 'Excel', 'C#'],
            technical_summary: `This example shows how to use Aspose.Cells for .NET for ${category.toLowerCase()}`,
            code_explanation: 'The example demonstrates basic usage patterns of the Aspose.Cells library.'
        };
    }
    ...
    determineDocsPath(category, title) {
        ...
        const categoryMap = {
            'Data': 'net/developer-guide/data',
            'Worksheets': 'net/developer-guide/worksheets',
            'Formatting': 'net/developer-guide/formatting',
            'Charts': 'net/developer-guide/charts',
            'Formulas': 'net/developer-guide/formulas',
            'PivotTable': 'net/developer-guide/pivot-tables',
            'Tables': 'net/developer-guide/tables'
        };
